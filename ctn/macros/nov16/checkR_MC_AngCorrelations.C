...
void checkR_MC_AngCorrelations() {
	...
	//INPUT FILE
	//char inputFile[250] = "/mnt/scratch/eli/outsim_iso.root"; //change        Isotropic simulation   
	//char inputFile[250] = "/mnt/scratch/eli/outsim_W.root";   //				Angular Correlations simulation
