...
// Output files
  ...
  Double_t pdgId=2212;   // gamma=22, electron=11; positron=-11; proton=2212 ; neutron=2112; Codes information in pdf: http://pdg.lbl.gov/mc_particle_id_contents.html
  Double_t theta1= 0.;  // polar angle distribution
  Double_t theta2= 15.;
  Double_t momentum=0.500; // 1== GeV/c; 1MeV
