...
void R3BModule::SetRotAnglesEuler(Double_t phi, Double_t theta, Double_t psi)
{
  ...
  if ( fLocalTrans == kFALSE ){
    ...
    LOG(INFO) << "R3BModule::SetRotAngles() is ignored ! ";
    LOG(INFO) << "R3BModule::SetRotAngles Local Transf. already activated ... ";
    fLabTrans = kFALSE;
  }
}
...
void R3BModule::SetRotAnglesXYZ(Double_t xx, Double_t yy, Double_t zz)
{
  ...
  if ( fLabTrans == kFALSE ){
    ...
    LOG(INFO) << "R3BModule::SetRotAnglesXYZ() is ignored ! ";
    LOG(INFO) << "R3BModule::SetRotAngles Lab Transf. already activated ... ";
    fLocalTrans = kFALSE;
  }
}
